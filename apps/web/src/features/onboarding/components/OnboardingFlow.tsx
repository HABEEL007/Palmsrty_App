...
export const OnboardingFlow: React.FC<OnboardingFlowProps> = ({ userId }) => {
  ...
  }, [currentStep, inputValue, answers, stepIndex, userId, navigate, refreshUser]);
        ...
        {!isTyping && (
          ...
          >
            <input
              ...
              className="w-full px-4 py-4 rounded-2xl text-sm outline-none text-slate-200 border-none bg-white/5 active:ring-1 active:ring-purple-500/50"
            />
