...
const REPORT_SERVICE_URL =
  (env as any)["REPORT_SERVICE_URL"] || "http://palmistry-report-service:10000";

app.use(
  "/api/image",
  createProxyMiddleware({ target: IMAGE_SERVICE_URL, changeOrigin: true }),
);
app.use(
  "/api/ai",
...
app.use(
  (err: unknown, _req: Request, res: Response, __next: NextFunction): void => {
